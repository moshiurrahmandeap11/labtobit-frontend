  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-16">
        <h2
          ref={textRef}
          className="text-[12vw] sm:text-[10vw] md:text-[8vw] font-bold uppercase tracking-tight leading-[0.85] cursor-default group"
        >
          <span className="block text-transparent [-webkit-text-stroke:2px_#52525b] group-hover:[-webkit-text-stroke:2px_#3b82f6] transition-all duration-700">
