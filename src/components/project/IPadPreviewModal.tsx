  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/60 backdrop-blur-sm flex items-center justify-center p-6 md:p-10" onClick={onClose}>
      ...
      <motion.div 
        ...
        className="relative w-full max-w-[1024px] aspect-[4/3] bg-black rounded-[32px] md:rounded-[48px] border-[10px] md:border-[16px] border-[#1a1a1a] shadow-[0_20px_50px_rgba(0,0,0,0.7)] overflow-hidden shrink-0 flex flex-col ring-1 ring-white/10"
      >
        {/* Hardware Buttons */}
        <div className="absolute top-[80px] -left-[10px] md:-left-[16px] w-1 h-12 bg-[#2a2a2a] rounded-l-md"></div>
        <div className="absolute top-[140px] -left-[10px] md:-left-[16px] w-1 h-12 bg-[#2a2a2a] rounded-l-md"></div>
        <div className="absolute top-[80px] -right-[10px] md:-right-[16px] w-1 h-16 bg-[#2a2a2a] rounded-r-md"></div>
        ...
        <div 
          className="flex-1 w-full relative overflow-hidden bg-black text-white rounded-[22px] md:rounded-[32px]"
          style={{
          ...
          <div className={`absolute top-0 left-0 right-0 h-8 z-[150] flex items-center justify-between px-6 pointer-events-none transition-colors ${activeApp && appUrl !== 'terminal' ? 'text-black' : 'text-white'}`}>
            ...
            <div className="flex items-center gap-2 opacity-90 drop-shadow-md">
              ...
              <div className="relative flex items-center">
                <div className="w-7 h-3.5 border border-current rounded-[4px] p-[1px] flex">
                  <div className="w-4/5 h-full bg-current rounded-[1.5px]"></div>
                </div>
                <div className="w-[1.5px] h-2 bg-current rounded-r-sm ml-[1px]"></div>
              </div>
            </div>
          </div>
